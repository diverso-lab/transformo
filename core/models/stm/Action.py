...
from core.models.stm.actions.CreateRelationAction import CreateRelationAction
    ...
    def __explore(self):
        ...
        if self.__transformation_action == "attribute":
            ...
            if self.__type == "move":
                ...
                # create action
                self.__apply = MoveAttributeAction(entity_from=copy(entity_from), entity_to=copy(entity_to),
        ...
        if self.__transformation_action == "relation":
            ...
            if self.__type == "create":
                ...
                # create action
                self.__apply = CreateRelationAction(first_entity=copy(relation.first_entity()),
                                                    second_entity=copy(relation.second_entity()))
